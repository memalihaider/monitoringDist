...
import { Globe, RefreshCw, Search, Clock, Zap, AlertTriangle, CheckCircle } from "lucide-react";
      ...
      <section className="admin-panel p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h3 className="admin-title text-2xl">Performance & uptime</h3>
            <p className="mt-2 text-sm text-(--admin-muted)">
              Monitor website availability, response times, and performance metrics.
            </p>
          </div>

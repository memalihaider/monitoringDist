    ...
    <div className="space-y-6">
      <section className="admin-panel p-6">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <p className="admin-eyebrow">Incident intake</p>
            <h3 className="admin-title text-2xl">Alert command desk</h3>
            <p className="mt-2 text-sm text-(--admin-muted)">
              Review live monitoring alerts and acknowledge incidents with full traceability.
            </p>
          </div>
